...
```
# Login to dockerhub
podman login --username $USER --password $PASSWD docker.io
...
kubectl create secret docker-registry mysecret2 --docker-server=https://index.docker.io/v1/ --docker-username=$USERID --docker-password=$PASSD
```
